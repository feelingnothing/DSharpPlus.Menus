...
namespace DSharpPlus.Menus.Entities
{
    ...
    {
        public StaticMenuButton(string id, ButtonStyle style, Func<DiscordInteraction, Task> callable,
            string label, ButtonRow row = ButtonRow.First, bool disabled = false, DiscordComponentEmoji? emoji = null)
        {
            Id = id;
            Style = style;
            Callable = callable;
    ...
    public abstract class StaticMenu : MenuBase
    {
        public StaticMenu(string id, DiscordClient client) : base(client, id)
        {
            ...
            CollectInteractionMethodsWithAttribute<StaticButtonAttribute>().ToList().ForEach(((MethodInfo i, StaticButtonAttribute a) t) =>
                Buttons.Add(new StaticMenuButton(t.a.Id, t.a.Style, t.i.CreateDelegate<Func<DiscordInteraction, Task>>(this), t.a.Label, t.a.Row, t.a.Disabled, t.a.Emoji)));
        }
